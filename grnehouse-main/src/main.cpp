...
ez::Drive chassis(
    ...
    {19, -20, 21},  // Right Chassis Ports (negative port will reverse it!)
...
//4 = R2, Middle
//5 = A, Bottem
//6 = Nothing state, Intake Straight to Hopper
//7 = Y, Go to top to Hopper
void spin_intake(int x) 
{

    //colorSort out for driver sort
    if(x==1)
    {
...
void count() 
{
  if (optical_sensorL.get_hue() < 10 || optical_sensorL.get_hue() > 350 || (optical_sensorL.get_hue() >= 180 && optical_sensorL.get_hue() <= 260) || (optical_sensorR.get_hue() < 10 || optical_sensorR.get_hue() > 350 || (optical_sensorR.get_hue() >= 180 && optical_sensorR.get_hue() <= 260))){
    if (intake.get_velocity() > 0) 
    {
        while (((optical_sensorL.get_hue() < 10 || optical_sensorL.get_hue() > 350 || (optical_sensorL.get_hue() >= 180 && optical_sensorL.get_hue() <= 260) || (optical_sensorR.get_hue() < 10 || optical_sensorR.get_hue() > 350 || (optical_sensorR.get_hue() >= 180 && optical_sensorR.get_hue() <= 260))) && (intake.get_velocity() > 0))){
          pros::delay(10);
        }
        BlockCount++;
        pros::delay(30);
